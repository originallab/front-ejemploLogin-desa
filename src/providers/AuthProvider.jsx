...
// Versión corregida para trabajar con tu API real
...
export const AuthProvider = ({ children }) => {
  ...
  const validateSession = async () => {
    try {
      ...
      // CORREGIDO: Verificar respuesta según tu API real
      // Tu API devuelve: {validated: 1, email: 'email@example.com'}
      if (response && (response.validated === 1 || response.success || response.valid || response.status === 'ok')) {
        ...
        const userData = {
          ...
          profile_img: response.profile_img || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face",
          session: session,
          // Agregar todos los datos de la respuesta
